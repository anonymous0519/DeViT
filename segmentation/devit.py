...
class DefactorizationTransformer(nn.Module):
    def __init__(self, img_size=224, patch_size=16, in_chans=3, num_classes=1000, embed_dims=[64, 128, 256, 512],
        ...
        super(DefactorizationTransformer, self).__init__()
...
class devit_b0(DefactorizationTransformer):
    def __init__(self, **kwargs):
        super(devit_b0, self).__init__(
            patch_size=4, embed_dims=[32, 64, 128, 256], num_heads=[1, 2, 4, 8], mlp_ratios=[8, 6, 4, 4],
            qkv_bias=True, norm_layer=partial(nn.LayerNorm, eps=1e-6), depths=[2, 2, 5, 2],
            drop_rate=0.0, drop_path_rate=0.1, pretrained=kwargs['pretrained'])

@BACKBONES.register_module()
class devit_b1(DefactorizationTransformer):
    def __init__(self, **kwargs):
        super(devit_b1, self).__init__(
            patch_size=4, embed_dims=[64, 128, 256, 512], num_heads=[1, 2, 4, 8], mlp_ratios=[8, 6, 4, 4],
            qkv_bias=True, norm_layer=partial(nn.LayerNorm, eps=1e-6), depths=[2, 2, 5, 2],
            drop_rate=0.0, drop_path_rate=0.1, pretrained=kwargs['pretrained'])

@BACKBONES.register_module()
class devit_b2(DefactorizationTransformer):
    def __init__(self, **kwargs):
        super(devit_b2, self).__init__(
            patch_size=4, embed_dims=[64, 128, 256, 512], num_heads=[1, 2, 4, 8], mlp_ratios=[8, 6, 4, 4],
            qkv_bias=True, norm_layer=partial(nn.LayerNorm, eps=1e-6), depths=[2, 3, 16, 3],
            drop_rate=0.0, drop_path_rate=0.1, pretrained=kwargs['pretrained'])


@BACKBONES.register_module()
class devit_b3(DefactorizationTransformer):
    def __init__(self, **kwargs):
        super(devit_b3, self).__init__(
            patch_size=4, embed_dims=[64, 128, 256, 512], num_heads=[1, 2, 4, 8], mlp_ratios=[8, 6, 4, 4],
            qkv_bias=True, norm_layer=partial(nn.LayerNorm, eps=1e-6), depths=[2, 4, 34, 4],
            drop_rate=0.0, drop_path_rate=0.1, pretrained=kwargs['pretrained'])

@BACKBONES.register_module()
class devit_b4(DefactorizationTransformer):
    def __init__(self, **kwargs):
        super(devit_b4, self).__init__(
            patch_size=4, embed_dims=[64, 128, 256, 512], num_heads=[1, 2, 4, 8], mlp_ratios=[8, 6, 4, 4],
            qkv_bias=True, norm_layer=partial(nn.LayerNorm, eps=1e-6), depths=[3, 4, 56, 4],
            drop_rate=0.0, drop_path_rate=0.1, pretrained=kwargs['pretrained'])


@BACKBONES.register_module()
class devit_b5(DefactorizationTransformer):
    def __init__(self, **kwargs):
        super(devit_b5, self).__init__(
            patch_size=4, embed_dims=[64, 128, 356, 512], num_heads=[1, 2, 4, 8], mlp_ratios=[4, 4, 4, 4],
            qkv_bias=True, norm_layer=partial(nn.LayerNorm, eps=1e-6), depths=[3, 4, 78, 4],
            drop_rate=0.0, drop_path_rate=0.1, pretrained=kwargs['pretrained'])